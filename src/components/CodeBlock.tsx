...
export function CodeBlock({ language, code, props }: CodeBlockProps) {
  ...
  return (
    <div className={cn("rounded-2xl overflow-hidden my-3 md:my-5 border bg-black/40 backdrop-blur-sm border-white/10 shadow-lg md:shadow-xl transition-all", isFullscreen && "fixed inset-2 md:inset-8 z-[100] m-0 flex flex-col shadow-2xl liquid-glass")}>
